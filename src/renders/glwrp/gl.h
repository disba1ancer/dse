...
using GLboolean = gl::GLboolean::underlying_type;
using GLenum = std::underlying_type_t<gl::GLenum>;
using gl::GLbitfield;
using gl::GLvoid;
using gl::GLbyte;
using gl::GLubyte;
...
//IMPORT_GL_FUNCTION(glDeleteFramebuffers, GLDELETEFRAMEBUFFERS);
//IMPORT_GL_FUNCTION(glFramebufferTexture2D, GLFRAMEBUFFERTEXTURE2D);
//IMPORT_GL_FUNCTION(glCheckFramebufferStatus, GLCHECKFRAMEBUFFERSTATUS);
//IMPORT_GL_FUNCTION(glClearBufferfv, GLCLEARBUFFERFV);
//IMPORT_GL_FUNCTION(glGenRenderbuffers, GLGENRENDERBUFFERS);
//IMPORT_GL_FUNCTION(glDeleteRenderbuffers, GLDELETERENDERBUFFERS);
//IMPORT_GL_FUNCTION(glBindRenderbuffer, GLBINDRENDERBUFFER);
//IMPORT_GL_FUNCTION(glRenderbufferStorage, GLRENDERBUFFERSTORAGE);
//IMPORT_GL_FUNCTION(glRenderbufferStorageMultisample, GLRENDERBUFFERSTORAGEMULTISAMPLE);
//IMPORT_GL_FUNCTION(glUniform4f, GLUNIFORM4F);
